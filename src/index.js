...
export function Menu() {
  ...
  return (
    <main className="menu">
      ...
      {/* When using a ternary operator, there are 3 parts, meaning we can display some alternatives*/}
      {numPizzas > 0 ? (
        <>
          <p>
...
function Footer() {
  ...
  // Demonstrating having a send return in the same component
  // if (!isOpen)
  //   return (
  //     <p>
  //       Sorry we're closed. Please stop by tomorrow when we open at {openHour}
  //       :00.
  //     </p>
  //   );
...
// React v18 method for rendering
...
// React before v18 (approximately)(for learning purposes)
